...
The following chapters explore important aspects of applied Machine Learning practice — for example: [modelling approaches](chapters/trees-intuition.qmd), [model evaluation](chapters/model-evaluation.qmd), and [data preprocessing](chapters/data-preprocessing.qmd).
...
The [last chapter](chapters/generative-ai.qmd) reflects on how modern generative models connect with the ideas presented here, and what that means for the future.

### Notes

- **This is a practical primer:** the book focuses on intuition and real-world thinking rather than formal proofs. If you would like a more code-heavy or mathematical approach, [please get in touch](https://eliottkalfon.com/contact).
