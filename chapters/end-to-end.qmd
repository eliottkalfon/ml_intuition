...
How would you solve the following problems with a Machine Learning model? What would you predict?
...
To choose between all of these model families and hyperparameter combinations, a single test set is not enough. ML practitioners generally use **cross-validation** over the training set. The interested reader can find more on this online [@sklearn_cross_validation_2025].
