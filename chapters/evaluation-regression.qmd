...
The absolute value of a number $x$ is noted $|x|$. It is the **magnitude** of the number, regardless of its sign. As an example $|2| = |-2| = 2$. When we average the absolute values of the error, we can compute the **Mean Absolute Error (MAE)** for $n$ observations:
...
Another way is to compute the average of the **squared errors**. This metric is called the **Mean Squared Error (MSE)** for $n$ observations:
...
- $\text{Errors}$:
    ...
    - $110-100=10$
    - $100-140=-40$
- $\text{Average Error} = \frac{30 + 10 + (-40)}{3} = 0$
- $\text{MAE} = \frac{|30| + |10| + |-40|}{3} = \frac{30 + 10 + 40}{3} = 26.67$
- $\text{MSE} = \frac{30^2 + 10^2 + (-40)^2}{3} = \frac{900 + 100 + 1600}{3} = \frac{2600}{3} \approx 866.67$
- $\text{RMSE} = \sqrt{866.67} \approx 29.43$
...
- $\text{Errors}$:
    ...
    - $100-100=0$
    - $140-140=0$
- $\text{Average Error} = \frac{20 + 0 + 0}{3} = 6.67$
- $\text{MAE} = \frac{|20| + |0| + |0|}{3} = \frac{20}{3} \approx 6.67$
- $\text{MSE} = \frac{20^2 + 0^2 + 0^2}{3} = \frac{400}{3} \approx 133.33$
- $\text{RMSE} = \sqrt{133.33} \approx 11.55$
...
- $\text{Errors}$:
    ...
    - $125-140=-15$
    - $100-150=-50$
- $\text{MAE} = \frac{|15| + |-15| + |-15| + |-50|}{4} = \frac{15 + 15 + 15 + 50}{4} = \frac{95}{4} = 23.75$
- $\text{MSE} = \frac{15^2 + (-15)^2 + (-15)^2 + (-50)^2}{4} = \frac{225 + 225 + 225 + 2500}{4} = \frac{3175}{4} = 793.75$
...
- $\text{Errors}$:
    ...
    - $130-140=-10$
    - $90-150=-60$
- $\text{MAE} = \frac{|10| + |-10| + |-10| + |-60|}{4} = \frac{10 + 10 + 10 + 60}{4} = \frac{90}{4} = 22.5$
- $\text{MSE} = \frac{10^2 + (-10)^2 + (-10)^2 + (-60)^2}{4} = \frac{100 + 100 + 100 + 3600}{4} = \frac{3900}{4} = 975$
:::
...
![Absolute value and square functions](/epub_images/evaluation/abs_vs_square.jpg)
:::
