...
![Tumour diagnosis classification problem](/epub_images/intro/scatter.jpg)
:::
...
::: {.content-visible when-format="epub"}
![First split](/epub_images/trees/example_first_split.jpg)
:::
...
::: {.content-visible when-format="epub"}
![All splits](/epub_images/trees/example_three_splits.jpg)
:::
...
::: {.content-visible when-format="epub"}
![Example tree](/epub_images/trees/tree_example.jpg){width=50%}
:::
...
::: {.content-visible when-format="epub"}
![Trying all combinations and picking the first split achieving the minimum Gini Impurity Coefficient](/epub_images/trees/split_and_gini_vs_x1.jpg)
:::
...
::: {.content-visible when-format="epub"}
![Splitting this initial dataset](/epub_images/intro/scatter.jpg)
:::
...
::: {.content-visible when-format="epub"}
![Trying different split values for Perimeter Mean](/epub_images/trees/scatter_and_gini_vs_perimeter.jpg)
:::
...
::: {.content-visible when-format="epub"}
![Trying different split values for Perimeter Mean](/epub_images/trees/gini_vs_area_and_scatter.jpg)
:::
