...
![Series with outlier](/epub_images/missing-values/series_with_outlier.jpg)
:::
...
::: {.content-visible when-format="epub"}
![Temperature time series with missing values](/epub_images/missing-values/time_series_missing_values.jpg)
:::
...
::: {.content-visible when-format="epub"}
![Imputation of missing values by mean](/epub_images/missing-values/time_series_mean.jpg)
:::
...
::: {.content-visible when-format="epub"}
![Imputation by previous value](/epub_images/missing-values/time_series_previous.jpg)
:::
...
::: {.content-visible when-format="epub"}
![Imputation by neighbours](/epub_images/missing-values/time_series_neighbours.jpg)
:::
