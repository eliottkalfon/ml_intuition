...
![Basic elements of a table](/images/data-space/table.png){width=60%}
:::

::: {.content-visible when-format="epub"}
![Basic elements of a table](/images/data-space/table.png){width=100%}
:::
...
::: {.content-visible unless-format="epub"}
![Plotting observations in two dimension](/images/data-space/scatter_plot_2d.png){width=50%}

![Plotting observations in three dimensions](/images/data-space/scatter_plot_3d.png){width=50%}
:::
