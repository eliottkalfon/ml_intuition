...
![Gemini-generated image of a Babylonian tablet, the author's drawing skills being insufficient for an original sketch](/epub_images/data-space/tablet.jpg){width=50%}
:::
...
::: {.content-visible when-format="epub"}
![Basic elements of a table](/epub_images/data-space/table.jpg)
:::
...
::: {.content-visible when-format="epub"}
![Plotting observations in two dimension](/epub_images/data-space/scatter_plot_2d.jpg){width=100%}
:::
...
::: {.content-visible when-format="epub"}
![Plotting observations in three dimensions](/epub_images/data-space/scatter_plot_3d.jpg){width=100%}
:::
