...
| Transaction Amount | Customer Age | Fraudulent? | Distance to (93,23) |
|:--------:|:-------:|:-----------:|:-------------------:|
| 95 | 22 | Yes | $\sqrt{(95-93)^2 + (22-23)^2} \approx 2.24$ |
| 90 | 25 | Yes | $\sqrt{(90-93)^2 + (25-23)^2} = \approx 3.61$ |
| 92 | 23 | Yes | $\sqrt{(92-93)^2 + (23-23)^2} = 1.00$ |
| 97 | 21 | Yes | $\sqrt{(97-93)^2 + (21-23)^2} = \approx 4.47$ |
| 93 | 24 | Yes | $\sqrt{(93-93)^2 + (24-23)^2} = 1.00$ |
| 94 | 23 | No | $\sqrt{(94-93)^2 + (23-23)^2} = 1.00$ |
| 20 | 80 | No | $\sqrt{(20-93)^2 + (80-23)^2} \approx 92.6$ |
| 25 | 78 | No | $\sqrt{(25-93)^2 + (78-23)^2} \approx 87.46$ |
| 18 | 82 | No | $\sqrt{(18-93)^2 + (82-23)^2} \approx 95.43$ |
| 23 | 77 | No | $\sqrt{(23-93)^2 + (77-23)^2} \approx 88.41$ |
