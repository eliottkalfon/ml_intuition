...
![New observation and example data](/images/trees/example_data.png){width=50%}
:::

::: {.content-visible when-format="epub"}
![New observation and example data](/images/trees/example_data.png){width=100%}
:::
...
::: {.content-visible unless-format="epub"}
![Example data with a single split](/images/trees/split.png){width=50%}
:::

::: {.content-visible when-format="epub"}
![Example data with a single split](/images/trees/split.png){width=100%}
:::
...
::: {.content-visible unless-format="epub"}
![A more complex example problem](/images/trees/complex_problem.png){width=50%}
:::
...
::: {.content-visible unless-format="epub"}
![XOR Problem: Can you find a single line separating the x from the o?](/images/trees/xor_problem.png){width=40%}
:::

::: {.content-visible when-format="epub"}
![XOR Problem: Can you find a single line separating the x from the o?](/images/trees/xor_problem.png){width=100%}
:::
...
::: {.content-visible when-format="epub"}
![Graphs are collections of nodes and edges connecting them](/images/trees/basic_graph.png){width=100%}
:::
...
::: {.content-visible when-format="epub"}
![Edges can be directed](/images/trees/cycles_direction.png){width=100%}
:::
...
::: {.content-visible when-format="epub"}
![A simple tree with seven nodes](/images/trees/tree_concepts.png){width=100%}
:::
...
::: {.content-visible when-format="epub"}
![Building a map with Decision Trees](/images/trees/decision_tree_partition_map.png){width=100%}
:::
