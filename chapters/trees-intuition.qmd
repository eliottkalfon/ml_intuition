...
![New observation and example data](/epub_images/trees/example_data.jpg)
:::

::: {.content-hidden when-format="epub"}
![New observation and example data](/images/trees/example_data.png)
:::
...
::: {.content-visible when-format="epub"}
![Example data with a single split](/epub_images/trees/split.jpg)
:::

::: {.content-hidden when-format="epub"}
![Example data with a single split](/images/trees/split.png)
:::
...
::: {.content-visible when-format="epub"}
![A more complex example problem](/epub_images/trees/complex_problem.jpg){width=100%}
:::

::: {.content-hidden when-format="epub"}
![A more complex example problem](/images/trees/complex_problem.png){width=100%}
:::
...
::: {.content-visible when-format="epub"}
![XOR Problem: Can you find a single line separating the x from the o?](/epub_images/trees/xor_problem.jpg)
:::
...
::: {.content-visible when-format="epub"}
![Splitting the data multiple times](/epub_images/trees/three_splits.jpg)
:::
...
::: {.content-visible when-format="epub"}
![Visualising splits as a Decision Tree](/epub_images/trees/tree_example.jpg)
:::
...
::: {.content-visible when-format="epub"}
![Decision Tree as a partition of space](/epub_images/trees/tree_numbered_partition.jpg)
:::
...
::: {.content-visible when-format="epub"}
![Graphs are collections of nodes and edges connecting them](/epub_images/trees/basic_graph.jpg){width=40%}
:::
...
::: {.content-visible when-format="epub"}
![Edges can be directed](/epub_images/trees/cycles_direction.jpg){width=40%}
:::
...
::: {.content-visible when-format="epub"}
![A simple tree with seven nodes](/epub_images/trees/tree_concepts.jpg){width=60%}
:::
...
::: {.content-visible when-format="epub"}
![Building a map with Decision Trees](/epub_images/trees/decision_tree_partition_map.jpg)
:::

::: {.content-hidden when-format="epub"}
![Building a map with Decision Trees](/images/trees/decision_tree_partition_map.png)
:::
