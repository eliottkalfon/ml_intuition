...
Recursion is a fascinating idea that builds on the concept of **function**. In programming, functions are reusable pieces of code that execute a given task.
...
- ambiguous: the same word can mean two or more things
...
You could call the function with `adder(2,3)` and get `5` as result.
...
In the Fibonacci sequence, the next term is the sum of the previous two, with the first two terms of the series being 0 and 1.
...
![Splitting the dataset](/epub_images/trees/split1_AB.jpg){width=80%}
:::

::: {.content-hidden when-format="epub"}
![Splitting the dataset](/images/trees/split1_AB.png){width=80%}
:::
...
::: {.content-visible when-format="epub"}
![Splitting Group B](/epub_images/trees/split2_ACD.jpg){width=80%}
:::

::: {.content-hidden when-format="epub"}
![Splitting Group B](/images/trees/split2_ACD.png){width=80%}
:::
...
::: {.content-visible when-format="epub"}
![Splitting Group A](/epub_images/trees/split3_EFCD.jpg){width=80%}
:::

::: {.content-hidden when-format="epub"}
![Splitting Group A](/images/trees/split3_EFCD.png){width=80%}
:::
