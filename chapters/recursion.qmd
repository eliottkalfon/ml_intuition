...
![Splitting the dataset](/images/trees/split1_AB.png){width=40%}
:::
...
::: {.content-visible unless-format="epub"}
![Splitting Group B](/images/trees/split2_ACD.png){width=40%}
:::
...
::: {.content-visible unless-format="epub"}
![Splitting Group A](/images/trees/split3_EFCD.png){width=40%}
:::
