...
![Non separable example data](/epub_images/trees/non_separable_data.jpg){width=100%}
:::
...
::: {.content-visible when-format="epub"}
![Properties by Size and Distance coloured by Property Price](/epub_images/trees/property_prices.jpg)
:::
...
::: {.content-visible when-format="epub"}
![Trying different splitting values of the size feature](/epub_images/trees/property_mse_vs_size.jpg)
:::
...
::: {.content-visible when-format="epub"}
![The Decision Tree learning algorithm selects the best split at each step](/epub_images/trees/property_regression_splits_stepwise.jpg)
:::
...
::: {.content-visible when-format="epub"}
![Resulting tree splitting on Customer Age ≤ 51](/epub_images/trees/fraud_tree_example.jpg)
:::
