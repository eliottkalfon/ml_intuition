...
La section suivante sera un peu plus mathématique et peut être ignorée ([section suivante](#fuite-dinformation-scaling)).
...
Si vous êtes déjà familier avec ceux-ci, n'hésitez pas à passer à la [section suivante](#fuite-dinformation-scaling).
...
## Fuite d'Information {#fuite-dinformation-scaling}
