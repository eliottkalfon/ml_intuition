...
![Plotting historical observations](images/intro/scatter.png){width=60%}
:::

::: {.content-visible when-format="epub"}
![Plotting historical observations](images/intro/scatter.png){width=100%}
:::
...
::: {.content-visible unless-format="epub"}
![Looking at the unknown observation](images/intro/scatter_unknown.png){width=60%}
:::

::: {.content-visible when-format="epub"}
![Looking at the unknown observation](images/intro/scatter_unknown.png){width=100%}
:::
...
![Calculating the distance between A and B](images/intro/distance.png){width=60%}

::: {.callout-note collapse="true"}
## Answer

![Thinking of distance as the hypotenuse of a right-angle triangle](images/intro/distance_triangle.png){width=60%}
